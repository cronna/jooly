    ...
    <div class="product-page">
        ...
        <div class="product-info">
            ...
            <div class="content-text">
                ...
                <span class='product-category'><b>Категория: </b><?= $product->category_id?></span>
            </div>
...
<script>
    let cardPrice = document.querySelector(".product-price")
    ...
    cardPrice.textContent = pricesStr
</script>